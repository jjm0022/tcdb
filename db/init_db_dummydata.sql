...
LOAD DATA INFILE '/var/lib/mysql-files/dummy_data/storms.csv' INTO TABLE storms FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA INFILE '/var/lib/mysql-files/dummy_data/observations.csv' INTO TABLE observations FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA INFILE '/var/lib/mysql-files/dummy_data/forecasts.csv' INTO TABLE forecasts FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA INFILE '/var/lib/mysql-files/dummy_data/tracks.csv' INTO TABLE tracks FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA INFILE '/var/lib/mysql-files/dummy_data/steps.csv' INTO TABLE steps FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
